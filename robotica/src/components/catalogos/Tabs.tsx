              ...
              <ul className="nicdark_tabslist grey">
                  <li>
                    <a
                      ...
                      onClick={
                        (target) => {
                          this.onClickTab(this.tabProductos);
                          this.props.clickHandler('tb1');
                        }}
                    >
                      <i
                        className={'icon-shop nicdark_displaynone_iphoneland ' +
                  ...
                  <li>
                    <a
                      ...
                      onClick={
                        (target) => {
                          this.onClickTab(this.tabServicios);
                          this.props.clickHandler('tb2');
                        }}
                    >
                      <i
                  ...
                  <li>
                    <a
                      ...
                      onClick={
                        (target) => {
                          this.onClickTab(this.tabCarrito);
                          this.props.clickHandler('tb3');
                        }}
                    >
                      <i
